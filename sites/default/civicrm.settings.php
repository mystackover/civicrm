...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/compucorp?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:@localhost/civicompucorp?new_link=true');
}
...
$civicrm_root = 'E:/wamp/www/drupal-7.54/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'E:/wamp/www/drupal-7.54\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/drupal-7.54/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '4a8e946b5a764f063ea8209cdb332f30');
}
...
// define( 'CIVICRM_MAIL_LOG', 'E:/wamp/www/drupal-7.54\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
